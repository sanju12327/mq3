...
document.getElementById("player_a").innerHTML = "Answer - " + player2_name;
 
function send () {
   number_1 = document.getElementById("one").value;
   number_2 = document.getElementById("two").value;
   console.log( "Problem = "+one+"X"+two);
 
   problem = "<h4>" + number_1 + "X" +number_2+ "</h4>";
   input_box = "<br>Answer : <input type='text' id='input_check_box'>";
   check_button = "<br><br><button class='btn btn-info' onclick='check();'>Check</button>";
   row = problem + input_box + check_button ;
